...
Sort the string lexicographical without using code and give your final answer (the sorted letters) inside <answer></answer> tags"""
...
args = vf.grpo_defaults(run_name = "Qwen3-1.7B-Lexo-Sort-GRPO")
